...
const WriteContainer = () => {
  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (exceedFiles.length > 0) alert(`${exceedFiles.join(", ")} 파일은 3MB를 초과하여 제외됩니다.`)
  ...
  const nextStep = async (e?: React.MouseEvent) => {
    ...
    switch (currentStep) {
      case 1:
        isValid = await trigger(["title", "content", "price", "service_fee", "cleaning_fee", "max_guests"])
        break
      case 2:
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                {errors.cleaning_fee && <p className="text-sm text-destructive">{errors.cleaning_fee.message}</p>}
              </div>
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">정확한 위치를 입력하면 게스트가 쉽게 찾을 수 있어요.</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="border-2 border-dashed border-muted-foreground/25 rounded-xl p-10 text-center hover:border-primary/50 transition-colors">
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-xl font-medium">사진을 끌어다 놓거나 클릭하여 업로드하세요</h4>
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="bg-muted/50 p-4 rounded-lg border-l-4 border-primary">
              <p className="text-sm">등록 후에도 정보를 수정할 수 있습니다. 등록 버튼을 클릭하면 숙소가 게시됩니다.</p>
            </div>
          </div>
        )
      default:
